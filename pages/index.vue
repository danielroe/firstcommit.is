<template>
  <div class="min-h-screen grid place-content-center">
    <main class="p-8 m-2 max-w-[500px] w-full mx-auto">
      <NuxtLink class="rounded bg-black text-white shadow px-3 py-2 flex flex-row gap-2 items-center" href="/connect/github" external>
